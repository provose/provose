...
When using Provose, you should set `source` to be `"github.com/provose/provose?ref=v1.0.1"`. Always make sure that the `ref=` parameter is pinned to a specific version to avoid Provose upgrading without your intention.
