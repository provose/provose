...
Terraform's documentation describes how to [download and install](https://learn.hashicorp.com/terraform/getting-started/install.html) the latest version of Terraform for your operating system. You will need **Terraform 0.13** or newer to use Provose.
...
Run `terraform init` again to download Provose v3.0.0 and the Terraform modules and providers that Provose depends on.
...
```terraform
{% include v3.0/tutorial/full_example/myproject.tf %}
```
